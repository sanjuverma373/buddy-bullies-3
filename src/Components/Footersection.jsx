...
const Footersection = () => {
        return (
                <div className=' bg-fimg bg-blue py-5' id="join">
                        <Container>
                                                ...
                                                <Row>
                                                        <Col className="col-6 ">                                                                
                                                                        <ul className='m-0 ps-0'>
                                                                                <li className='fs-sm1 fw-medium text-white lh-150 mb-2'>Resources</li>
                                                                                <li className='mb-1'><a className='fs-sm fw-normal lh-136 text-white ' href="">Roadmap</a></li>
                                                                                <li className='mb-1'><a className='fs-sm fw-normal lh-136 text-white ' href="">FAQs</a></li>
                                                                                <li><a className='fs-sm fw-normal lh-136 text-white ' href="">Mint your Bully</a></li>
                                                                        </ul>                                                               
                                                        </Col>
                                                        <Col className="col-6 ">
